$(function () {
    $('#add_senders').on('submit', addSender);
...
function addSender() {
    ...
    $.post('/ajax/integrations/measoft/add-sender', $(this).serialize(), function (json) {
        if (json.success) {
...
function editTable() {
    $('.edit').editable({
        url : '/ajax/integrations/measoft/edit-sender',
        ajaxOptions : {
            type : 'post',
            dataType : 'json'
        },
    ...
    $('.delete').editable({
        ...
        '</span>',
        url : '/ajax/integrations/measoft/delete-sender',
        ajaxOptions : {
            type : 'post',
            dataType : 'json'
        },
