...
@section('title') @lang('general.payment') {{$company->name}}@stop
...
@section('jsBottom')
    ...
    <script src="{{ URL::asset('js/finance/new-payout.js') }}"></script>
@stop
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div id="content-header" class="clearfix">
                        <div class="pull-left">
                            <ol class="breadcrumb">
                                <li class="active"><span> @lang('finance.payment-company') {{$company->name}}</span></li>
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="main-box-body clearfix">
                        <form class=" form-horizontal" method="post">
                            ...
                            <div class="form-group">
                                <label for="period_start" class="col-sm-4 control-label" style="text-align: left;">Период</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group text-center">
                                <a class="btn btn-success" id="unlock" style="cursor: pointer; " data-id="{{$company->id}}">
                            ...
                            <div class="block_price" style="display: none">
                                <div class="form-group">
                                    <label for="valuation" class="col-sm-4 control-label" style="text-align: left;" > @lang('general.sum')</label>
                                    <div class="col-sm-8">
                                ...
                                <div class="form-group">
                                    <label for="comment" class="col-sm-4 control-label" style="text-align: left;"> @lang('general.comment')</label>
                                    <div class="col-sm-8">
