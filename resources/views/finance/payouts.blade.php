...
@section('title') @lang('finance.payments') @stop
    ...
    <div class="row">
        <div class="col-lg-12">
            <ol class="breadcrumb">
                ...
                <li class="active"><span> @lang('finance.payments')</span></li>
            </ol>
            <div class="clearfix">
                <h1 class="pull-left"> @lang('finance.payments')</h1>
            </div>
        </div>
    </div>
    <div class="row">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">{{$payout->company}}</td>
