    ...
    <div class="row">
        <div class="col-lg-12">
            <ol class="breadcrumb">
                ...
                <li class="active"><span> @lang('finance.transactions')</span></li>
            </ol>
            <div class="clearfix">
                <h1 class="pull-left"> @lang('finance.transactions')</h1>
            </div>
        </div>
    </div>
    <div class="row">
            ...
            <div class="main-box clearfix">
                    <div class="tabs-wrapper profile-tabs">
                        <ul class="nav nav-tabs">
                            @if (isset($permissions['page_balance_companies']))
                                <li>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade in active " id="statistics">
                                <form class="form" method="post" action="{{ route("finance-transactions-companies") }}" style="padding: 0;">
                                    <div class="main-box">
                                        <div class="item_rows ">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-1">
                                                        <div class="checkbox-nice">
                                                            <input type="checkbox" id="trans_payed" name="trans_payed" @if (isset($_GET['trans_payed'])) checked @endif>
                                                    ...
                                                    <div class="form-group col-md-3 col-sm-6 form-horizontal">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control" id="oid" name="oid"  value="@if (isset($_GET['oid'])){{ $_GET['oid'] }}@endif">
                                                        </div>
                                                    </div>
                                                    <div class="form-group col-md-3 col-sm-6 form-horizontal">
                                                    ...
                                                    @if (isset($permissions['filter_companies_page_transaction_companies']))
                                                    <div class="form-group col-md-3 col-sm-6 form-horizontal">
                                                    ...
                                                    <div class="form-group col-md-3 col-sm-6 form-horizontal">
                                                        <div class="col-sm-12">
                                                            <div class="input-group">
                                                                ...
                                                                <input class="form-control" id="date_start" type="text" placeholder=" @lang('general.from')" data-toggle="tooltip" name="date_start"
                                                                       data-placement="bottom" title=" @lang('general.from')" value="@if (isset($_GET['date_start'])){{ $_GET['date_start'] }}@endif">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group col-md-3 col-sm-6 form-horizontal">
                                                        <div class="col-sm-12">
                                                            <div class="input-group">
                                                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                                                <input class="form-control" id="date_end" type="text" data-toggle="tooltip" placeholder=" @lang('general.to')" name="date_end"
                                                                       data-placement="bottom" title=" @lang('general.to')" value="@if (isset($_GET['date_end'])){{ $_GET['date_end']}}@endif">
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="btns_filter">
                                        ...
                                        <a href="{{ route('finance-transactions-companies') }}" class="btn btn-warning" type="submit"> @lang('general.reset')</a>
                                    </div>
