...
@section('content')
    <div class="md-modal md-effect-2" id="form_block">
        <div class="md-content">
            ...
            <form method="post" class="form-horizontal" id="add_token">
                <div class="modal-body">
                    ...
                    @endif
                    <div class="form-group">
                        <label class="col-md-3 control-label required" for="token">Токен</label>
                        <div class="col-md-9">
                            <input required name="token" id="token" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label required" for="name">Название</label>
                        <div class="col-md-9">
            ...
            <div class="main-box clearfix">
                <div class="tabs-wrapper profile-tabs">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade in active " id="block_keys">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="main-box clearfix">
                                        <div class="table-responsive">
                                            <table class="table table-hover table-striped integrations_table">
                                                ...
                                                <tbody>
                                                    @include('integrations.wefast.edit-table')
                                                </tbody>
                                            </table>
                                        </div>
                                    </div>
