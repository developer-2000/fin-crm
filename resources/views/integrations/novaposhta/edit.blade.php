...
@section('content')
    <div class="md-modal md-effect-2" id="form_block">
        <div class="md-content">
            ...
            <form method="post" class="form-horizontal" id="integrations-keys-create">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label" for="name">Ключ</label>
                        <div class="col-md-9">
                            <input required name="key" id="key" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label" for="exp_key_date">Дата истечения действия ключа</label>
                        <div class="col-md-9">
                            <input id="datetimepicker" name="exp_key_date" type="text" class="form-control" value="">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label" for="size">Габариты по умолчанию</label>
                        <div class="col-md-9">
                            <input required name="size" id="size" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label" for="weight">Вес по умолчанию</label>
                        <div class="col-md-9">
                            <input required name="weight" id="weight" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="comment" class="col-md-3 control-label">Описание</label>
                        <div class="col-md-9">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary integrations_keys_create">Добавить</button>
                </div>
            ...
            <div class="main-box clearfix">
                <div class="tabs-wrapper profile-tabs">
                    <ul class="nav nav-tabs">
                        ...
                        @endif
                        {{--<li class="">--}}
                        {{--<a href="{{route('codes-statuses',  Request::segment(2))}}">Коды/статусы</a>--}}
                        {{--</li>--}}
                    </ul>
                    <div class="tab-content">
                        <div class="tab-pane fade in active " id="keys">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="main-box clearfix">
                                        <div class="table-responsive">
                                            <table class="table table-hover table-striped integrations_table">
                                                ...
                                                <tbody class="keys">
                                                @include('integrations.novaposhta.integrations-keys-table')
                                                </tbody>
                                            </table>
                                        </div>
                                    </div>
