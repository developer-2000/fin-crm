...
@section('title') @lang('general.passes') (@lang('general.good-client'))@stop
    ...
    <div class="row">
        <div class="col-lg-12">
            <ol class="breadcrumb">
                ...
                <li class="active"><span> @lang('general.good-client')</span></li>
            </ol>
            <div class="clearfix">
                <h1 class="pull-left"> @lang('general.good-client')</h1>
                @if ($pass->active)
                <div class="pull-right">
                    <div class="row">
                        <form method="post" class="form-inline" id="form_track" style="display: inline;">
                            <div class="form-group">
                                <label for="pass"> @lang('general.pass')</label>
                        ...
                        <div class="item_rows ">
                            <div class="main-box-body clearfix">
                                <div class="row">
                                    ...
                                    <input type="hidden" name="type" value="redemption">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="main-box-body clearfix">
                        <div class="table-responsive">
                            <table class="table table-striped table-hover"  id="pass_table">
                                ...
                                <tbody>
                                    @include('orders.pass.redemption-table')
                                </tbody>
                            </table>
                        </div>
                        @if ($pass->active)
