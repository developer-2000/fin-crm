...
@section('title') @lang('general.passes') (@lang('general.bad-client'))@stop
    ...
    <div class="row">
        <div class="col-lg-12">
            <ol class="breadcrumb">
                ...
                <li class="active"><span> @lang('general.bad-client')</span></li>
            </ol>
            <div class="clearfix">
                <h1 class="pull-left"> @lang('general.bad-client')</h1>
                @if ($pass->active)
                        ...
                        <div class="item_rows ">
                            <div class="main-box-body clearfix">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-3 col-sm-6 form-horizontal">
                                        <label for="index" class="col-sm-4 control-label">
                                            @lang('general.Index')
                                        </label>
                                        <div class="col-sm-8">
                                    ...
                                    <input type="hidden" name="type" value="no-redemption">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <form id="save_pass" method="post" action="{{route('pass-save', $pass->id)}}">
                            <div class="table-responsive">
                                <table class="table table-striped table-hover" id="pass_table">
                                    ...
                                    <tbody>
                                        @include('orders.pass.no-redemption-table')
                                    </tbody>
                                </table>
                            </div>
                            @if ($pass->active)
