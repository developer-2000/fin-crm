                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <span class="label label-default"
                                  @if ($order->procStatus) style="background-color: {{$order->procStatus->color}};" @endif>
                                {{ !empty($order->procStatus->key) ?
                                trans('statuses.' . $order->procStatus->key) : $order->procStatus->name}}
                            </span>
                        </td>
                        <td>
