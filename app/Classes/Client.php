...
use App\Classes\Base\BaseClient;
use Mockery\Exception;

function custom_map_callback($key, $value) {
	return "$key: $value";
}
...
//	$map = array_map('custom_map_callback', array_keys($headers), $headers);

	$header = '';
	$header .= "GET ";
	$header .= $path_with_query . " HTTP/1.1\r\n";
	$header .= implode("\r\n", $map);
	$header .= "\r\n\r\n";
